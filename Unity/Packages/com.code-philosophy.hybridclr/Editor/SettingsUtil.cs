...
namespace HybridCLR.Editor
{
    public static class SettingsUtil
    {
        ...
        public static bool buildHotfixAssembliesAOT
        {
            get => HybridCLRSettings.Instance.buildHotfixAssembliesAOT;
            set 
            {
                HybridCLRSettings.Instance.buildHotfixAssembliesAOT = value;
                HybridCLRSettings.Save();
            }
        }
