...
namespace SuperScrollView
{
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        public void SetDistanceForRecycle(float mDistanceForRecycle0, float mDistanceForRecycle1)
        {
            this.mDistanceForRecycle0 = mDistanceForRecycle0;
            this.mDistanceForRecycle1 = mDistanceForRecycle1;
        }

        public void SetDistanceForNew(float mDistanceForNew0, float mDistanceForNew1)
        {
            this.mDistanceForNew0 = mDistanceForNew0;
            this.mDistanceForNew1 = mDistanceForNew1;
        }
